...
public class CordovaPlugin {
    public CordovaWebViewImplInterface webView;
    public com.mtsdealersolutions.cordova_webview.CordovaInterface cordova;
     ...
     */
    public final void privateInitialize(String serviceName, com.mtsdealersolutions.cordova_webview.CordovaInterface cordova, CordovaWebViewImplInterface webView, CordovaPreferences preferences) {
     ...
     */
    public void initialize(com.mtsdealersolutions.cordova_webview.CordovaInterface cordova, CordovaWebViewImplInterface webView) {
    }
     ...
     */
    public boolean execute(String action, String rawArgs, com.mtsdealersolutions.cordova_webview.CallbackContext callbackContext) throws JSONException {
     ...
     * @return                Whether the action was valid.
     */
    public boolean execute(String action, JSONArray args, com.mtsdealersolutions.cordova_webview.CallbackContext callbackContext) throws JSONException {
        com.mtsdealersolutions.cordova_webview.CordovaArgs cordovaArgs = new com.mtsdealersolutions.cordova_webview.CordovaArgs(args);
     ...
     * @return                Whether the action was valid.
     */
    public boolean execute(String action, com.mtsdealersolutions.cordova_webview.CordovaArgs args, com.mtsdealersolutions.cordova_webview.CallbackContext callbackContext) throws JSONException {
        return false;
    }
     ...
     */
    public void onRestoreStateForActivityResult(Bundle state, com.mtsdealersolutions.cordova_webview.CallbackContext callbackContext) {}
     ...
     */
    public com.mtsdealersolutions.cordova_webview.CordovaResourceApi.OpenForReadResult handleOpenForRead(Uri uri) throws IOException {
    ...
    protected Uri toPluginUri(Uri origUri) {
        return new Uri.Builder()
            .scheme(com.mtsdealersolutions.cordova_webview.CordovaResourceApi.PLUGIN_URI_SCHEME)
     ...
     *
     */
    public boolean onReceivedHttpAuthRequest(CordovaWebViewImplInterface view, ICordovaHttpAuthHandler handler, String host, String realm) {
        return false;
    }
     ...
     *
     */
    public boolean onReceivedClientCertRequest(CordovaWebViewImplInterface view, com.mtsdealersolutions.cordova_webview.ICordovaClientCertRequest request) {
        return false;
    }
