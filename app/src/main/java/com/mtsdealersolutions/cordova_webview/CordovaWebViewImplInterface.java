 ...
 */
public interface CordovaWebViewImplInterface {
    public static final String CORDOVA_VERSION = "6.2.0-dev";

    void init(CordovaInterface cordova, List<PluginEntry> pluginEntries, com.mtsdealersolutions.cordova_webview.CordovaPreferences preferences);
    ...
    com.mtsdealersolutions.cordova_webview.CordovaResourceApi getResourceApi();

    void setButtonPlumbedToJs(int keyCode, boolean override);
    boolean isButtonPlumbedToJs(int keyCode);

    void sendPluginResult(com.mtsdealersolutions.cordova_webview.PluginResult cr, String callbackId);

    com.mtsdealersolutions.cordova_webview.PluginManager getPluginManager();
    com.mtsdealersolutions.cordova_webview.CordovaWebViewEngine getEngine();
    com.mtsdealersolutions.cordova_webview.CordovaPreferences getPreferences();
    com.mtsdealersolutions.cordova_webview.ICordovaCookieManager getCookieManager();
