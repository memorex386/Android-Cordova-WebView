...
public class PluginManager {
    ...
    private final CordovaWebViewImplInterface app;
    private boolean isInitialized;

    private CordovaPlugin permissionRequester;

    public PluginManager(CordovaWebViewImplInterface cordovaWebViewImplInterface, CordovaInterface cordova, Collection<PluginEntry> pluginEntries) {
        this.ctx = cordova;
        this.app = cordovaWebViewImplInterface;
    ...
    public void exec(final String service, final String action, final String callbackId, final String rawArgs) {
        ...
        if (plugin == null) {
            ...
            com.mtsdealersolutions.cordova_webview.PluginResult cr = new com.mtsdealersolutions.cordova_webview.PluginResult(com.mtsdealersolutions.cordova_webview.PluginResult.Status.CLASS_NOT_FOUND_EXCEPTION);
        ...
        try {
            ...
            if (!wasValidAction) {
                com.mtsdealersolutions.cordova_webview.PluginResult cr = new com.mtsdealersolutions.cordova_webview.PluginResult(com.mtsdealersolutions.cordova_webview.PluginResult.Status.INVALID_ACTION);
                callbackContext.sendPluginResult(cr);
            }
        } catch (JSONException e) {
            com.mtsdealersolutions.cordova_webview.PluginResult cr = new com.mtsdealersolutions.cordova_webview.PluginResult(com.mtsdealersolutions.cordova_webview.PluginResult.Status.JSON_EXCEPTION);
            callbackContext.sendPluginResult(cr);
        } catch (Exception e) {
     ...
     */
    public boolean onReceivedClientCertRequest(CordovaWebViewImplInterface view, ICordovaClientCertRequest request) {
        for (CordovaPlugin plugin : this.pluginMap.values()) {
