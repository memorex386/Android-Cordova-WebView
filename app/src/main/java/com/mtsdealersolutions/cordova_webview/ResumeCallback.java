...
public class ResumeCallback extends CallbackContext {
    ...
    @Override
    public void sendPluginResult(com.mtsdealersolutions.cordova_webview.PluginResult pluginResult) {
        synchronized (this) {
            if (finished) {
        ...
        try {
            ...
            pluginResultObject.put("pluginStatus", com.mtsdealersolutions.cordova_webview.PluginResult.StatusMessages[pluginResult.getStatus()]);
        ...
        com.mtsdealersolutions.cordova_webview.PluginResult eventResult = new com.mtsdealersolutions.cordova_webview.PluginResult(com.mtsdealersolutions.cordova_webview.PluginResult.Status.OK, event);
        ...
        List<com.mtsdealersolutions.cordova_webview.PluginResult> result = new ArrayList<com.mtsdealersolutions.cordova_webview.PluginResult>();
        result.add(eventResult);
        result.add(pluginResult);

        CoreAndroid appPlugin = (CoreAndroid) pluginManager.getPlugin(CoreAndroid.PLUGIN_NAME);
        appPlugin.sendResumeEvent(new com.mtsdealersolutions.cordova_webview.PluginResult(com.mtsdealersolutions.cordova_webview.PluginResult.Status.OK, result));
    }
}
