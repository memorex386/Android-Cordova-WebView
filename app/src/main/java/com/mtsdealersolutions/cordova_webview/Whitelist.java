    ...
    private static class URLPattern {
        ...
        public boolean matches(Uri uri) {
            try {
                ...
                com.mtsdealersolutions.cordova_webview.LOG.d(TAG, e.toString());
                return false;
            }
        }
    }
        ...
        if (whiteList != null) {
            try {
                ...
                if (origin.compareTo("*") == 0) {
                    com.mtsdealersolutions.cordova_webview.LOG.d(TAG, "Unlimited access to network resources");
                    whiteList = null;
                }
                ...
                com.mtsdealersolutions.cordova_webview.LOG.d(TAG, "Failed to add origin %s", origin);
            }
        }
    }
